...
exports.medicineCollectionSchema = void 0;
exports.createMedicineCollection = createMedicineCollection;
exports.deleteMedicineCollection = deleteMedicineCollection;
exports.getMedicineCollectionInfo = getMedicineCollectionInfo;
/**
 ...
 */
exports.medicineCollectionSchema = {
    name: 'medicines',
    fields: [
        {
            name: 'canonicalId',
 ...
 */
async function createMedicineCollection(client) {
    try {
        const collection = await client.collections().create(exports.medicineCollectionSchema);
 ...
 * @param client - Typesense client instance
 */
async function deleteMedicineCollection(client) {
    try {
 ...
 * @param client - Typesense client instance
 */
async function getMedicineCollectionInfo(client) {
    try {
