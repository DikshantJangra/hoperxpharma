...
export default function ERxPrescriptionsPage() {
    const [prescriptions, setPrescriptions] = useState<ERxPrescription[]>([]);
            ...
            <div className="bg-white border-b border-gray-200 sticky top-0 z-30">
                <div className="max-w-7xl mx-auto px-6 py-4">
                    <div className="flex items-center gap-4 mb-4">
                        ...
                        <button className="px-4 py-2.5 bg-cyan-600 text-white rounded-lg font-medium hover:bg-cyan-700 transition-colors flex items-center gap-2" disabled={isLoading}>
                ...
                <div className="space-y-4">
                    {isLoading ? (
                        ...
                        <div className="text-center py-16">
                            ...
                            <button className="px-6 py-3 bg-cyan-600 text-white rounded-lg font-medium hover:bg-cyan-700 transition-colors inline-flex items-center gap-2" disabled={isLoading}>
