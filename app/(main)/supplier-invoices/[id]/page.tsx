...
export default function InvoiceDetailPage() {
    ...
    const handleDownloadPdf = async () => {
        try {
            ...
            const blob = await supplierInvoiceApi.downloadPdf(invoiceId);
                    ...
                    <div className="flex items-center justify-between mb-6 print:hidden">
                        ...
                        <div className="flex gap-3">
                            <button
                                ...
                                className="px-4 py-2 border border-slate-300 rounded-lg text-slate-700 hover:bg-slate-50 flex items-center gap-2 print:hidden disabled:opacity-50 disabled:cursor-not-allowed"
                            >
                                {downloadingPdf ? (
                                    <>
                        ...
                        <div className="flex justify-between items-start mb-8 pb-6 border-b border-slate-200">
                            <div>
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className={`px-3 py-1 rounded-full text-sm font-medium ${invoice.paymentStatus === 'PAID'
                                        ? 'bg-green-100 text-green-700'
                                ...
                                <div className="space-y-4">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 ${paymentData.amount && parseFloat(paymentData.amount) > remainingAmount
                                                ? 'border-red-500'
                                                : 'border-slate-300'
                                                }`}
