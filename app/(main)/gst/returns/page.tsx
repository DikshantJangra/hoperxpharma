                    ...
                    <div className="space-y-6">
                        <div className="bg-white border border-gray-200 rounded-xl p-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
                                    ...
                                    <div className="text-sm text-gray-600 mt-1">₹12,50,000</div>
                                </div>
                                <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
                                    ...
                                    <div className="text-sm text-gray-600 mt-1">₹8,50,000</div>
                                </div>
                                <div className="p-4 bg-amber-50 border border-amber-200 rounded-lg">
                                    <div className="text-sm text-gray-600 mb-1">B2C Others</div>
                                    <div className="text-2xl font-bold text-amber-900">₹2,50,000</div>
                        ...
                        <div className="bg-white border border-gray-200 rounded-xl p-6">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <button className="px-6 py-3 bg-gray-100 text-gray-700 rounded-lg font-semibold hover:bg-gray-200 transition-colors flex items-center justify-center gap-2">
                            ...
                            <div className="space-y-4">
                                <div className="p-4 bg-gray-50 rounded-lg">
                                    <div className="flex items-center justify-between mb-2">
                                        ...
                                        <span className="font-bold text-gray-900">₹23,50,000</span>
                                    </div>
                                    <div className="grid grid-cols-3 gap-4 text-sm">
                                        <div>
                                            <div className="text-gray-600">CGST</div>
                                            <div className="font-semibold text-blue-900">₹1,41,000</div>
                                        </div>
                                        <div>
                                            <div className="text-gray-600">SGST</div>
                                            <div className="font-semibold text-green-900">₹1,41,000</div>
                                        </div>
                                        <div>
                                            <div className="text-gray-600">IGST</div>
                                            <div className="font-semibold text-amber-900">₹51,000</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="p-4 bg-green-50 border-2 border-green-300 rounded-lg">
                                    <div className="flex items-center justify-between">
                                        ...
                                        <span className="text-2xl font-bold text-green-900">₹2,88,000</span>
                                    </div>
                                </div>
                            </div>
                        </div>
