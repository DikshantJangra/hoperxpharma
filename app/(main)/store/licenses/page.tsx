    ...
    <div className="h-screen flex flex-col bg-[#f8fafc]">
      <div className="bg-white border-b border-[#e2e8f0] px-6 py-4">
        ...
        <div className="relative mb-4">
          ...
          <input type="text" value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} placeholder="Search by license no, authority, doc name, uploader..." className="w-full pl-10 pr-4 py-2 border border-[#cbd5e1] rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0ea5a3]" />
        </div>
      ...
      <div className="flex-1 flex overflow-hidden">
        <LicenseList filter={filter} searchQuery={searchQuery} onSelectLicense={setSelectedLicense} />
