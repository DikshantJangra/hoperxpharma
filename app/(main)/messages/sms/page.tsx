    ...
    <div className="h-screen flex flex-col bg-[#f8fafc]">
      ...
      <div className="bg-white border-b border-[#e2e8f0] p-4">
        <div className="flex items-center justify-between mb-3">
          ...
          <div className="flex items-center gap-3">
            <div className="text-right">
              ...
              <select className="text-sm font-medium text-[#0f172a] border-none focus:outline-none">
            ...
            <div className="text-right">
              ...
              <p className="text-sm font-semibold text-[#0f172a]">3,240</p>
            </div>
        ...
        <div className="flex items-center gap-2 text-xs">
          ...
          <span className="text-[#64748b]">Cost/day: ₹24.50</span>
          <span className="text-[#64748b]">•</span>
          <span className="text-[#64748b]">Throttle: 5 msg/sec</span>
        </div>
      </div>
