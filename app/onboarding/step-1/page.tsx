...
import { FiInfo, FiArrowRight, FiHome, FiMapPin, FiType, FiPhone, FiMail } from "react-icons/fi";
        ...
        >
            ...
            >
                ...
                <div className="pt-4 flex justify-end">
                    <button
                        onClick={handleNext}
                        className="px-8 py-3.5 rounded-xl font-semibold transition-all flex items-center gap-2 bg-emerald-500 text-white hover:bg-emerald-600 shadow-lg shadow-emerald-500/30 hover:shadow-emerald-500/40 transform hover:-translate-y-0.5 active:translate-y-0"
                    >
