    ...
    if (selectedFile) {
      ...
      setTimeout(() => {
        const mockOCR: OCRResult = {
          ocrId: 'ocr_001',
          vendorCandidates: [{ id: 'sup_001', score: 0.92, name: 'ABC Supplies' }],
          invoiceNumber: 'INV-2025-001',
          invoiceDate: '2025-11-10',
          dueDate: '2025-12-10',
          lines: [{ desc: 'Medical supplies', qty: 100, rate: 100, gstPercent: 12 }],
          confidence: 0.88
        };
        setOcrResult(mockOCR);
        setFormData({
          vendorId: mockOCR.vendorCandidates[0].id,
          invoiceNumber: mockOCR.invoiceNumber,
          invoiceDate: mockOCR.invoiceDate,
          dueDate: mockOCR.dueDate,
          grossAmount: 10000,
          gstAmount: 1800,
